...
--
-- Host: localhost
-- Generation Time: May 14, 2018 at 03:10 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertClass` (`ClassName` VARCHAR(20))  BEGIN
...
INSERT INTO `ncomments` (`comment_id`, `comment_subject`, `comment_text`, `comment_status`, `UserID`) VALUES
(15, '', 'Nour', 1, 1),
(16, '', 'Ahmed', 1, 1),
(17, '', 'kkljlkjkl', 1, 1),
(18, '', 'Shafey', 1, 1),
...
CREATE TABLE `salariespayment` (
  `ID` int(11) NOT NULL,
  `ValueToBePaid` float DEFAULT NULL,
