...
--
-- Host: localhost
-- Generation Time: May 13, 2018 at 05:02 PM
...
(3, 3, 1, '123'),
(16, 15, 12, 'Joe'),
(17, 16, 12, 'Data@gmail.com'),
(18, 15, 13, 'Drmahmoud'),
(19, 17, 13, 'male'),
(20, 16, 13, 'mahmoud'),
(21, 23, 14, 'Dc John Monir'),
(22, 25, 14, 'john'),
(23, 26, 14, '123'),
(24, 15, 15, 'John'),
(25, 17, 15, 'male'),
(26, 16, 15, 'john1500463@miuegypt.edu.eg'),
(27, 22, 15, 'No'),
(28, 23, 16, 'Dc Mohamed'),
(29, 25, 16, 'JohnMonir'),
(30, 26, 16, 'aaa'),
(31, 15, 17, 'Youssef'),
(32, 17, 17, 'male'),
(33, 16, 17, 'John1500463@miuegypt.edu.eg'),
(34, 22, 17, 'No'),
(61, 15, 21, 'Shafey'),
(62, 17, 21, 'male'),
(63, 16, 21, 'sadfasdf'),
...
(16, 13, '2018-04-30 12:56:54', 1),
(23, 12, '2018-05-11 23:25:04', 1);
...
(2, 1, 'hhhhhhh', 'gfhf'),
(3, 1, 'Alphabets letters', 'ABCDE'),
(4, 3, 'Gravity', 'How to measure Gravity');
...
INSERT INTO `ncomments` (`comment_id`, `comment_subject`, `comment_text`, `comment_status`) VALUES
(15, '', 'Nour', 1),
(16, '', 'Ahmed', 1),
(17, '', 'kkljlkjkl', 1),
(18, '', 'Shafey', 1);
...
INSERT INTO `studentrating` (`ID`, `UserID`, `CurriculumID`, `Rating`, `Date`) VALUES
(14, 12, 3, 4, '2018-05-13'),
(15, 12, 2, 4, '2018-05-13'),
(18, 12, 4, 2, '2018-05-13'),
(20, 21, 3, 4, '2018-05-13');
...
(10, 2, 1, '2018-04-30 10:40:11', 5),
(11, 1, 1, '2018-04-30 11:34:48', 5),
(12, 2, 1, '2018-04-30 12:35:05', 1),
(13, 2, 1, '2018-04-30 12:49:19', 1),
(14, 4, 1, '2018-05-10 14:49:47', 1),
(15, 2, 1, '2018-05-11 17:13:42', 1),
(16, 4, 1, '2018-05-11 17:16:41', 1),
(17, 2, 1, '2018-05-11 17:24:52', 1),
(18, 4, 1, '2018-05-12 08:52:03', 1),
(19, 2, 1, '2018-05-13 10:36:53', 5),
(20, 2, 1, '2018-05-13 10:40:35', 5),
(21, 2, 1, '2018-05-13 13:15:24', 5);
...
--
ALTER TABLE `applicationgroup`
  MODIFY `ApplicationGroupID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `resources`
  ADD CONSTRAINT `reference` FOREIGN KEY (`ParentID`) REFERENCES `resources` (`ID`);
