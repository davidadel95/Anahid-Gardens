...
--
-- Host: localhost
-- Generation Time: Apr 30, 2018 at 10:32 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ViewRoleNameEAV` ()  NO SQL
SELECT * FROM Role$$
...
(6, 'Student', '../php/Dashboard.php'),
(7, 'Nanny', '../php/Dashboard.php'),
(9, 'TA', '../php/Parent.php');
...
--
ALTER TABLE `application`
  ADD CONSTRAINT `ApplicationOptionID` FOREIGN KEY (`ApplicationOptionID`) REFERENCES `applicationoptions` (`ID`),
