        ...
        <div class="forms">
          <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="eg: service">
                </div>
                <div class="form-group">
                  <label>Place</label>
                  <input type="text" class="form-control" placeholder="eg: place">
                </div>
                <div class="form-group">
                  <label>Price</label>
                ...
                <div class="form-group">
                  <label>Details</label>
                  <input type="text" class="form-control" placeholder="eg: details">
                </div>
                <div class="form-group">
