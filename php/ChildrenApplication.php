	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
	   <?php include("Navigationbar2.php"); ?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Child application</h2>
					...
					<div class="form-two widget-shadow">
						...
						<div class="form-body" data-example-id="simple-form-inline">
							...
							<div class="form-two widget-shadow">
						<div class="form-title">
							<h4>Picker information:</h4><div class="form-group"><p class="help-block">The responsible to pick the child from the nursery </p></div>
						</div>
						<div class="form-body" data-example-id="simple-form-inline">
							<form class="form-inline">
						...
						<div class="form-two widget-shadow">
						<div class="form-title">
							<h4>Emergency information:</h4>	<div class="form-group"><p class="help-block">In case of emergency, Other person than parents to contact him/her</p></div>
						...
						<div class="form-body" data-example-id="simple-form-inline">
							...
							<br>
							<div class="form-group"> <label for="exampleInputName2">Are there any allergic to certain things?</label> <input type="text" class="form-control" id="exampleInputName2" placeholder="State any"> </div> <br>
							<br>
							<div class="form-group"> <label for="exampleInputEmail2">What is your child hobbies?</label> <input type="email" class="form-control" id="exampleInputEmail2" placeholder="State any"> </div> <br>
							<br>
							<div class="form-group"> <label for="exampleInputEmail2">Date of starting with the kid?</label> <input type="date" class="form-control" id="exampleInputEmail2" placeholder="Date"> </div> <br>
							<br>
							<div class="form-group"> <label for="exampleInputEmail2">How did you know us?</label> <input type="email" class="form-control" id="exampleInputEmail2" placeholder="..."> </div>
